...
export default function AdminLoginPage() {
  ...
  return (
    <div className="login-brand-panel relative min-h-dvh flex items-center justify-center p-6">
      ...
      <footer className="absolute bottom-5 left-0 right-0 flex flex-col items-center justify-center gap-1 text-[11px] text-white/35 z-10">
