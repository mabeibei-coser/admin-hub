...
export type ProjectId = "report" | "nav" | "startup" | "tailor" | "salary" | "hazard" | "interview" | "teaching";
...
export interface ProjectMeta {
  ...
  color: "blue" | "green" | "purple" | "orange" | "cyan" | "amber" | "rose" | "indigo";
  /** 报告章节数（详情页用来标题里显示，可选） */
  sectionCount: number;
  /** 业务描述（sidebar / 标题副文案） */
  description?: string;
